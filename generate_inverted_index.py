...
with open(os.path.join("inverted_indexes", "title_inverted_index.json"), "w") as f:
    json.dump(title_index, f, default=serialize_sets)

with open(os.path.join("inverted_indexes", "description_inverted_index.json"), "w") as f:
